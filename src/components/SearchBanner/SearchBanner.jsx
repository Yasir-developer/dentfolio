            ...
            <div className="bg-white w-3/5 rounded-[7px] max-w-[1800px] mx-4	">
              ...
              <div className="flex items-center p-4 w-full">
                ...
                <div className='border border-gray-300 w-full flex items-center rounded-[5px]'>
                  ...
                  <input type="text" placeholder="Search" className="flex-grow py-2 px-4 focus:outline-none w-4/5" />
                  <FaFilter size={24} color="#000" />

                  <button className="bg-custom-blue text-white px-4 py-2 rounded ml-2 focus:outline-none">Search</button>
                </div>
              </div>
            </div>
