...
const Footer = () => {
  return (
    <footer className='bg-footer-blue'>
        ...
        <hr className='justify-center items-center w-full border-[#707070] my-10' ></hr>
      
        </div>
        <div className='justify-between	flex flex-row' >
            <p className='text-white font-normal'>© Copyright 2023 Dentfolio. All Rights Reserved.</p>
