...
const MembershipBenefits = () => {
  return (
    <div className="items-center">
      <h1 className="mt-10 text-[32px] font-semibold">MEMBERSHIP BENEFITS</h1>
      <p className="text-[18px] text-custom-blue font-medium mt-5">
        Get new patients!
      </p>
      ...
      <div className="flex mt-10 items-center gap-x-2">
        <FaAngleDoubleRight size={18} className="text-custom-blue " />{" "}
        <p className="text-[18px] font-semibold">Grow your private list </p>
      </div>
    </div>
  );
};
